...
Fortunately, the systemfonts package provides a solution: as well as looking for fonts installed with your operating system, it will also look for fonts in the `fonts/` directory of your current project. This means that means you can save a font file in that directory, and then use it in your plots. For example, this book includes a copy of the "Rubik Moonrocks" font, allowing me to use it in the following plot:
